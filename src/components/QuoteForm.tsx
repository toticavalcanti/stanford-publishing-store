...
export default function QuoteForm({ initialProfile = "escuela" }: { initialProfile?: string }) {
  ...
  if (sent) {
    return (
      <div className="confirmation">
        ...
        <p className="muted">
          Un asesor de Stanford Publishing responde con la cotización formal y las condiciones de la
          zona. Referencia de seguimiento: <strong>COT-2026-0184</strong>.
        </p>
        <div className="row">
        ...
        <p className="small muted">
          En el prototipo nada se envía: la pantalla muestra cómo se vería la confirmación.
        </p>
      </div>
    );
  }
    ...
    >
      ...
      <div className="field-row">
        ...
        <div className="field">
          ...
          <input id="telefono" name="telefono" placeholder="443 000 0000" />
        </div>
      </div>
      ...
      <div className="field-row">
        ...
        <div className="field">
          ...
          <input id="alumnos" name="alumnos" type="number" min={1} defaultValue={30} />
        </div>
      </div>

      <div className="field">
        <label htmlFor="detalle">Títulos o paquetes de interés</label>
        <textarea
          id="detalle"
          name="detalle"
          placeholder="Paquete de 1.er semestre MCCEMS 2025, más Buzzing 1 para dos grupos."
        />
      </div>
